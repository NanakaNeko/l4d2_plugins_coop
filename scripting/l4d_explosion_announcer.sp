...
public void OnPluginStart()
{
    ...
    g_hCvar_Team               = CreateConVar("l4d_explosion_announcer_team", "7", "提示消息发送给那些团队. 0=没有, 1=幸存者, 2=感染者, 4=旁观者, 8=幸存者NPC. 如需启用多个把数字加起来. 例如: 3=幸存者+感染者.", CVAR_FLAGS, true, 0.0, true, 15.0);
    ...
    switch (type)
    {
        ...
        case TYPE_OIL_DRUM_EXPLOSIVE:
        {
            ...
            for (int client = 1; client <= MaxClients; client++)
            {
                ...
                CPrintToChat(client, "{default}[{green}!{default}] {blue}%N {olive}打爆了爆炸大油桶", attacker);
            }
        }
    }
}
